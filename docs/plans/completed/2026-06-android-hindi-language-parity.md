...
**Created:** 2026-06-29
**Status:** DONE (2026-06-29) — `Language.HI` enum entry, `locales_config.xml` hi locale, and a
full `res/values-hi/strings.xml` (409/409 keys) all landed; XML validated well-formed with
placeholder parity vs. the English baseline. Hindi now shows as "हिन्दी" in the Settings dialog.
